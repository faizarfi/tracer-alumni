...
<head>
    <meta charset="UTF-8" />
    <title>Edit Kaprodi - UIN Raden Mas Said</title>
    ...
    <style>
        ...
        /* Sidebar specific styles (dipertahankan agar layout konsisten) */
        #sidebar {
    ...
    <main class="flex-1 p-4 sm:p-4 lg:p-6 flex flex-col">
            ...
            <header class="mb-6 p-3 bg-white rounded-xl shadow-md flex items-center justify-between animate-fade-in">
                ...
                <div class="flex-grow">
                    ...
                    <p class="text-green-700 text-sm mt-1">Ubah informasi Kaprodi: {{ $kaprodi->name ?? 'Kaprodi Tidak Ditemukan' }}</p>
                </div>
            ...
            <div class="container mx-auto bg-white rounded-2xl shadow-2xl border border-gray-200 p-4 flex-1">
                ...
                <form action="{{ route('admin.kaprodi.update', $kaprodi->id) }}" method="POST" class="space-y-6">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 pt-4 border-t mt-6">Ubah Password (Opsional)</h3>
